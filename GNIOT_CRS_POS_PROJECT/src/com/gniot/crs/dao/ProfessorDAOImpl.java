...
import com.gniot.crs.exception.EnrolledStudentsRetrievalException;
import com.gniot.crs.exception.GradeUpdateException;
...
public class ProfessorDAOImpl implements ProfessorDAOInterface {
    ...
    public List<StudentDetails> getEnrolledStudentsInCourse(int courseId) {
	 ...
	 */
    public List<StudentDetails> getEnrolledStudents(int professorId) {
        List<StudentDetails> students = new ArrayList<>();
        try (Connection conn = DBUtils.getConnection()) {
